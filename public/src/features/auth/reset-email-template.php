<!-- features/auth/reset-email-template.php
     Native PHP template for the password-reset verification code. Rendered via
     ob_start()/ob_get_clean() from the auth service. -->
...
<div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; max-width: 480px; margin: 0 auto; padding: 24px; background: #f8fafc; color: #0f172a; line-height: 1.6;">
    <div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 14px; padding: 28px;">
        ...
        <p style="margin: 0 0 20px; color: #475569; font-size: 14px;">
            Use the 6-digit code below to reset your password. Your password will not be
            changed until you verify this code. This code expires in <?= (int) $expiryMinutes ?> minutes.
        </p>
